...
nam250 =     ['FWHMCIV_slices/nobals/Stripe82_Helms_FWHMCIV_nobal500.fits']
nam250_err = ['FWHMCIV_slices/nobals/Stripe82_Helms_FWHMCIV_nobal500err.txt']
...
pic250_2 = readfits('hers_PLW_tan_spirepix_sanePic_20130321.fits',hd250_2,ext=1)
wei250_2 = readfits('hers_PLW_tan_spirepix_sanePic_20130321.fits',hd250_2,ext=2)


;get coords for 500 for helms in terms of pixels
EXTAST, hd250, astrhd
...
;get coords for 500 for hers in terms of pixels
...
fits_write,"test_psf_500.fits", newpsf
...
;err_pop = sqrt((eflux^2)*(number+number2) - (wei_stdev^2))
