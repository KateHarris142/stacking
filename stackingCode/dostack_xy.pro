pro dostack_xy, image, x_arr, y_arr, img_stack,$
...
; img_stack is an empty array of size 61*61, same for wei_stack
     img_stack = img_stack + img_tmp*wei_tmp     ; puts image*weigth insto correct sibscript in img_stack
...
; If there are more than one image to stack,
  IF Nstacked NE 0 THEN BEGIN
     ...
     img_stack  = img_stack / wei_stack    ; works but I dont know why.
